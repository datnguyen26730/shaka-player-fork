...
goog.provide('shaka.ui.AudioSelection');
 ...
 * @export
 */
shaka.ui.AudioSelection = class extends shaka.ui.SettingsMenu {
  /**
  ...
  constructor(parent, controls) {
    ...
    this.button.classList.add('shaka-audio-selection-button');
    this.button.classList.add('shaka-tooltip-status');
    this.menu.classList.add('shaka-audio-selection');
 ...
 * @final
 */
shaka.ui.AudioSelection.Factory = class {
  /** @override */
  create(rootElement, controls) {
    return new shaka.ui.AudioSelection(rootElement, controls);
  }
};

shaka.ui.OverflowMenu.registerElement(
    'audio_selection', new shaka.ui.AudioSelection.Factory());
